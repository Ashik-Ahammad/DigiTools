    ...
    <div>
      <div className=" bg-[#4F39F6] flex flex-col items-center justify-center text-center  py-28 px-6 gap-y-3">
        ...
        <div className="flex flex-wrap justify-center lg:justify-start gap-4 pt-2 my-3 ">
          <button className="bg-white hover:bg-transparent hover:text-white transition-all px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold text-base sm:text-lg shadow-xl shadow-red-500/30 flex items-center gap-2 sm:gap-3 text-primart hover:cursor-pointer">
            Explore Products
          </button>
